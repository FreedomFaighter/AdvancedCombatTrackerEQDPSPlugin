...
namespace EverQuestDPSPlugin {
    ...
    internal class EverQuestDPSPluginResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to (?&lt;victim&gt;.+) is (?&lt;damageShieldDamageType&gt;\S+) by (?&lt;attacker&gt;.+) (?&lt;damageShieldType&gt;\S+) for (?&lt;damagePoints&gt;[\d]+) points of non-melee damage..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to (?&lt;healer&gt;.+?) (?:has been\s){0,1}healed (?&lt;healingTarget&gt;^[over time]|.+?)(?:\s(?&lt;overTime&gt;over time)){0,1} for (?&lt;healingPoints&gt;[\d]+)(?:\s\((?&lt;overHealPoints&gt;[\d]+)\)){0,1} hit point(?:|s) by (?&lt;healingSpell&gt;.*)\.(?:[\s][\(](?&lt;healingSpecial&gt;.+)[\)]){0,1}.
        /// </summary>
